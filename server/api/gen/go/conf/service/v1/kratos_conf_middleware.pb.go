...
// 	protoc        (unknown)
// source: conf/service/v1/kratos_conf_middleware.proto
...
func (x *Middleware) Reset() {
	*x = Middleware{}
	if protoimpl.UnsafeEnabled {
		mi := &file_conf_service_v1_kratos_conf_middleware_proto_msgTypes[0]
...
func (*Middleware) Descriptor() ([]byte, []int) {
	return file_conf_service_v1_kratos_conf_middleware_proto_rawDescGZIP(), []int{0}
}
...
func (x *Middleware_Auth) Reset() {
	*x = Middleware_Auth{}
	if protoimpl.UnsafeEnabled {
		mi := &file_conf_service_v1_kratos_conf_middleware_proto_msgTypes[1]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*Middleware_Auth) Descriptor() ([]byte, []int) {
	return file_conf_service_v1_kratos_conf_middleware_proto_rawDescGZIP(), []int{0, 0}
}
...
func (x *Middleware_RateLimiter) Reset() {
	*x = Middleware_RateLimiter{}
	if protoimpl.UnsafeEnabled {
		mi := &file_conf_service_v1_kratos_conf_middleware_proto_msgTypes[2]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*Middleware_RateLimiter) Descriptor() ([]byte, []int) {
	return file_conf_service_v1_kratos_conf_middleware_proto_rawDescGZIP(), []int{0, 1}
}
...
func (x *Middleware_Metrics) Reset() {
	*x = Middleware_Metrics{}
	if protoimpl.UnsafeEnabled {
		mi := &file_conf_service_v1_kratos_conf_middleware_proto_msgTypes[3]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*Middleware_Metrics) Descriptor() ([]byte, []int) {
	return file_conf_service_v1_kratos_conf_middleware_proto_rawDescGZIP(), []int{0, 2}
}
...
var File_conf_service_v1_kratos_conf_middleware_proto protoreflect.FileDescriptor

var file_conf_service_v1_kratos_conf_middleware_proto_rawDesc = []byte{
	0x0a, 0x2c, 0x63, 0x6f, 0x6e, 0x66, 0x2f, 0x73, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x2f, 0x76,
	0x31, 0x2f, 0x6b, 0x72, 0x61, 0x74, 0x6f, 0x73, 0x5f, 0x63, 0x6f, 0x6e, 0x66, 0x5f, 0x6d, 0x69,
	0x64, 0x64, 0x6c, 0x65, 0x77, 0x61, 0x72, 0x65, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x12, 0x0f,
	0x63, 0x6f, 0x6e, 0x66, 0x2e, 0x73, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x2e, 0x76, 0x31, 0x1a,
	0x1e, 0x67, 0x6f, 0x6f, 0x67, 0x6c, 0x65, 0x2f, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x62, 0x75, 0x66,
	0x2f, 0x64, 0x75, 0x72, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22,
	0xe2, 0x04, 0x0a, 0x0a, 0x4d, 0x69, 0x64, 0x64, 0x6c, 0x65, 0x77, 0x61, 0x72, 0x65, 0x12, 0x25,
	...
	,
	...
	0x6d, 0x61, 0x72, 0x79, 0x42, 0xbb, 0x01, 0x0a, 0x13, 0x63, 0x6f, 0x6d, 0x2e, 0x63, 0x6f, 0x6e,
	0x66, 0x2e, 0x73, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x2e, 0x76, 0x31, 0x42, 0x19, 0x4b, 0x72,
	0x61, 0x74, 0x6f, 0x73, 0x43, 0x6f, 0x6e, 0x66, 0x4d, 0x69, 0x64, 0x64, 0x6c, 0x65, 0x77, 0x61,
	0x72, 0x65, 0x50, 0x72, 0x6f, 0x74, 0x6f, 0x50, 0x01, 0x5a, 0x2b, 0x6d, 0x6f, 0x73, 0x6f, 0x6e,
...
var (
	file_conf_service_v1_kratos_conf_middleware_proto_rawDescOnce sync.Once
	file_conf_service_v1_kratos_conf_middleware_proto_rawDescData = file_conf_service_v1_kratos_conf_middleware_proto_rawDesc
)

func file_conf_service_v1_kratos_conf_middleware_proto_rawDescGZIP() []byte {
	file_conf_service_v1_kratos_conf_middleware_proto_rawDescOnce.Do(func() {
		file_conf_service_v1_kratos_conf_middleware_proto_rawDescData = protoimpl.X.CompressGZIP(file_conf_service_v1_kratos_conf_middleware_proto_rawDescData)
	})
	return file_conf_service_v1_kratos_conf_middleware_proto_rawDescData
}

var file_conf_service_v1_kratos_conf_middleware_proto_msgTypes = make([]protoimpl.MessageInfo, 4)
var file_conf_service_v1_kratos_conf_middleware_proto_goTypes = []interface{}{
	(*Middleware)(nil),             // 0: conf.service.v1.Middleware
	(*Middleware_Auth)(nil),        // 1: conf.service.v1.Middleware.Auth
	(*Middleware_RateLimiter)(nil), // 2: conf.service.v1.Middleware.RateLimiter
	(*Middleware_Metrics)(nil),     // 3: conf.service.v1.Middleware.Metrics
}
var file_conf_service_v1_kratos_conf_middleware_proto_depIdxs = []int32{
	2, // 0: conf.service.v1.Middleware.limiter:type_name -> conf.service.v1.Middleware.RateLimiter
	3, // 1: conf.service.v1.Middleware.metrics:type_name -> conf.service.v1.Middleware.Metrics
	1, // 2: conf.service.v1.Middleware.auth:type_name -> conf.service.v1.Middleware.Auth
...
func init() { file_conf_service_v1_kratos_conf_middleware_proto_init() }
func file_conf_service_v1_kratos_conf_middleware_proto_init() {
	if File_conf_service_v1_kratos_conf_middleware_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_conf_service_v1_kratos_conf_middleware_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		file_conf_service_v1_kratos_conf_middleware_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
		...
		file_conf_service_v1_kratos_conf_middleware_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
		...
		file_conf_service_v1_kratos_conf_middleware_proto_msgTypes[3].Exporter = func(v interface{}, i int) interface{} {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_conf_service_v1_kratos_conf_middleware_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   4,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_conf_service_v1_kratos_conf_middleware_proto_goTypes,
		DependencyIndexes: file_conf_service_v1_kratos_conf_middleware_proto_depIdxs,
		MessageInfos:      file_conf_service_v1_kratos_conf_middleware_proto_msgTypes,
	}.Build()
	File_conf_service_v1_kratos_conf_middleware_proto = out.File
	file_conf_service_v1_kratos_conf_middleware_proto_rawDesc = nil
	file_conf_service_v1_kratos_conf_middleware_proto_goTypes = nil
	file_conf_service_v1_kratos_conf_middleware_proto_depIdxs = nil
}
